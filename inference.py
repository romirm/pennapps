...
RECENT ATC COMMUNICATIONS:"""
    ...
    def advise(self, bottleneck_data, squack_data):
        ...
        print("&&&", chatter_section)

        prompt = f"""
        You are an expert in aviation and airport traffic control at John F Kennedy (JFK) International Airport. An advanced machine learning model
        ...
        Recent ATC chatter context from transcribed_chatter.txt:
        {chatter_section}
