...
AIRPORTS = {
    ...
    'DFW': {
        ...
        'taxiways': [
            {'id': 'A', 'points': [(100, 200), (200, 200), (300, 200), (400, 200), (500, 200), (600, 200), (700, 200)]},
            {'id': 'B', 'points': [(100, 250), (200, 250), (300, 250), (400, 250), (500, 250), (600, 250), (700, 250)]},
            {'id': 'C', 'points': [(100, 300), (200, 300), (300, 300), (400, 300), (500, 300), (600, 300), (700, 300)]},
            {'id': 'D', 'points': [(100, 350), (200, 350), (300, 350), (400, 350), (500, 350), (600, 350), (700, 350)]},
            {'id': 'E', 'points': [(100, 400), (200, 400), (300, 400), (400, 400), (500, 400), (600, 400), (700, 400)]},
            {'id': 'F', 'points': [(100, 450), (200, 450), (300, 450), (400, 450), (500, 450), (600, 450), (700, 450)]},
            {'id': 'G', 'points': [(100, 500), (200, 500), (300, 500), (400, 500), (500, 500), (600, 500), (700, 500)]},
            {'id': 'H', 'points': [(100, 550), (200, 550), (300, 550), (400, 550), (500, 550), (600, 550), (700, 550)]},
            {'id': 'J', 'points': [(100, 600), (200, 600), (300, 600), (400, 600), (500, 600), (600, 600), (700, 600)]},
            {'id': 'K', 'points': [(100, 650), (200, 650), (300, 650), (400, 650), (500, 650), (600, 650), (700, 650)]},
            {'id': 'L', 'points': [(100, 700), (200, 700), (300, 700), (400, 700), (500, 700), (600, 700), (700, 700)]},
            {'id': 'M', 'points': [(100, 750), (200, 750), (300, 750), (400, 750), (500, 750), (600, 750), (700, 750)]},
            {'id': 'N', 'points': [(100, 800), (200, 800), (300, 800), (400, 800), (500, 800), (600, 800), (700, 800)]},
            {'id': 'P', 'points': [(100, 850), (200, 850), (300, 850), (400, 850), (500, 850), (600, 850), (700, 850)]},
            {'id': 'Q', 'points': [(100, 900), (200, 900), (300, 900), (400, 900), (500, 900), (600, 900), (700, 900)]},
            {'id': 'R', 'points': [(100, 950), (200, 950), (300, 950), (400, 950), (500, 950), (600, 950), (700, 950)]},
            {'id': 'S', 'points': [(100, 1000), (200, 1000), (300, 1000), (400, 1000), (500, 1000), (600, 1000), (700, 1000)]},
            {'id': 'T', 'points': [(100, 1050), (200, 1050), (300, 1050), (400, 1050), (500, 1050), (600, 1050), (700, 1050)]},
            {'id': 'U', 'points': [(100, 1100), (200, 1100), (300, 1100), (400, 1100), (500, 1100), (600, 1100), (700, 1100)]},
            {'id': 'V', 'points': [(100, 1150), (200, 1150), (300, 1150), (400, 1150), (500, 1150), (600, 1150), (700, 1150)]},
            {'id': 'W', 'points': [(100, 1200), (200, 1200), (300, 1200), (400, 1200), (500, 1200), (600, 1200), (700, 1200)]},
            {'id': 'X', 'points': [(100, 1250), (200, 1250), (300, 1250), (400, 1250), (500, 1250), (600, 1250), (700, 1250)]},
            {'id': 'Y', 'points': [(100, 1300), (200, 1300), (300, 1300), (400, 1300), (500, 1300), (600, 1300), (700, 1300)]},
            {'id': 'Z', 'points': [(100, 1350), (200, 1350), (300, 1350), (400, 1350), (500, 1350), (600, 1350), (700, 1350)]},
            {'id': 'AA', 'points': [(100, 1400), (200, 1400), (300, 1400), (400, 1400), (500, 1400), (600, 1400), (700, 1400)]},
            {'id': 'BB', 'points': [(100, 1450), (200, 1450), (300, 1450), (400, 1450), (500, 1450), (600, 1450), (700, 1450)]},
            {'id': 'CC', 'points': [(100, 1500), (200, 1500), (300, 1500), (400, 1500), (500, 1500), (600, 1500), (700, 1500)]},
            {'id': 'DD', 'points': [(100, 1550), (200, 1550), (300, 1550), (400, 1550), (500, 1550), (600, 1550), (700, 1550)]},
            {'id': 'EE', 'points': [(100, 1600), (200, 1600), (300, 1600), (400, 1600), (500, 1600), (600, 1600), (700, 1600)]},
            {'id': 'FF', 'points': [(100, 1650), (200, 1650), (300, 1650), (400, 1650), (500, 1650), (600, 1650), (700, 1650)]},
            {'id': 'GG', 'points': [(100, 1700), (200, 1700), (300, 1700), (400, 1700), (500, 1700), (600, 1700), (700, 1700)]},
            {'id': 'HH', 'points': [(100, 1750), (200, 1750), (300, 1750), (400, 1750), (500, 1750), (600, 1750), (700, 1750)]},
            {'id': 'JJ', 'points': [(100, 1800), (200, 1800), (300, 1800), (400, 1800), (500, 1800), (600, 1800), (700, 1800)]},
            {'id': 'KK', 'points': [(100, 1850), (200, 1850), (300, 1850), (400, 1850), (500, 1850), (600, 1850), (700, 1850)]},
            {'id': 'LL', 'points': [(100, 1900), (200, 1900), (300, 1900), (400, 1900), (500, 1900), (600, 1900), (700, 1900)]},
            {'id': 'MM', 'points': [(100, 1950), (200, 1950), (300, 1950), (400, 1950), (500, 1950), (600, 1950), (700, 1950)]},
            {'id': 'NN', 'points': [(100, 2000), (200, 2000), (300, 2000), (400, 2000), (500, 2000), (600, 2000), (700, 2000)]},
            {'id': 'PP', 'points': [(100, 2050), (200, 2050), (300, 2050), (400, 2050), (500, 2050), (600, 2050), (700, 2050)]},
            {'id': 'QQ', 'points': [(100, 2100), (200, 2100), (300, 2100), (400, 2100), (500, 2100), (600, 2100), (700, 2100)]},
            {'id': 'RR', 'points': [(100, 2150), (200, 2150), (300, 2150), (400, 2150), (500, 2150), (600, 2150), (700, 2150)]},
            {'id': 'SS', 'points': [(100, 2200), (200, 2200), (300, 2200), (400, 2200), (500, 2200), (600, 2200), (700, 2200)]},
            {'id': 'TT', 'points': [(100, 2250), (200, 2250), (300, 2250), (400, 2250), (500, 2250), (600, 2250), (700, 2250)]},
            {'id': 'UU', 'points': [(100, 2300), (200, 2300), (300, 2300), (400, 2300), (500, 2300), (600, 2300), (700, 2300)]},
            {'id': 'VV', 'points': [(100, 2350), (200, 2350), (300, 2350), (400, 2350), (500, 2350), (600, 2350), (700, 2350)]},
            {'id': 'WW', 'points': [(100, 2400), (200, 2400), (300, 2400), (400, 2400), (500, 2400), (600, 2400), (700, 2400)]},
            {'id': 'XX', 'points': [(100, 2450), (200, 2450), (300, 2450), (400, 2450), (500, 2450), (600, 2450), (700, 2450)]},
            {'id': 'YY', 'points': [(100, 2500), (200, 2500), (300, 2500), (400, 2500), (500, 2500), (600, 2500), (700, 2500)]},
            {'id': 'ZZ', 'points': [(100, 2550), (200, 2550), (300, 2550), (400, 2550), (500, 2550), (600, 2550), (700, 2550)]},
            # Cross taxiways
            {'id': 'AAA', 'points': [(150, 100), (150, 300), (150, 500), (150, 700), (150, 900), (150, 1100), (150, 1300), (150, 1500)]},
            {'id': 'BBB', 'points': [(250, 100), (250, 300), (250, 500), (250, 700), (250, 900), (250, 1100), (250, 1300), (250, 1500)]},
            {'id': 'CCC', 'points': [(350, 100), (350, 300), (350, 500), (350, 700), (350, 900), (350, 1100), (350, 1300), (350, 1500)]},
            {'id': 'DDD', 'points': [(450, 100), (450, 300), (450, 500), (450, 700), (450, 900), (450, 1100), (450, 1300), (450, 1500)]},
            {'id': 'EEE', 'points': [(550, 100), (550, 300), (550, 500), (550, 700), (550, 900), (550, 1100), (550, 1300), (550, 1500)]},
            {'id': 'FFF', 'points': [(650, 100), (650, 300), (650, 500), (650, 700), (650, 900), (650, 1100), (650, 1300), (650, 1500)]}
        ]
    },
    'ATL': {
        'name': 'Hartsfield-Jackson Atlanta International Airport',
